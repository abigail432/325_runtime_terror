...
const initialFloors = [
  ...
  {floor: 6, busy: 0, type:2, title:"Digital Scholarship Center; Book Stacks: K, M"},
  {floor: 7, busy: 2, type:2, title:"IT Instructional Media Lab"},
  {floor: 8, busy: 2, type:0, title:"Book Stacks: P-PQ5999"},
  {floor: 9, busy: 0, type:1, title:"Book Stacks: N, TR"},
  {floor: 10, busy: 2, type:2, title:"Learning Resource Center"},
  {floor: 11, busy: 2, type:0, title:"Book Stacks: PQ6000-PT"},
  {floor: 12, busy: 2, type:2, title:"Supplemental Instruction"},
  {floor: 13, busy: 2, type:2, title:"Writing Program"},
  {floor: 14, busy: 0, type:0, title:"Book Stacks: DS-DZ, E, F"},
  {floor: 15, busy: 1, type:1, title:"Book Stacks: C, D-DR"},
  {floor: 16, busy: 1, type:2, title:"IT Computer Classrooms"},
  {floor: 17, busy: 1, type:0, title:"Book Stacks: HG2000-HZ, J"},
  {floor: 18, busy: 2, type:1, title:"Book Stacks: G, H-HG-1999"},
  {floor: 19, busy: 2, type:2, title:"Office of Scholarly Communication"},
  {floor: 20, busy: 2, type:0, title:"Book Stacks: B, L"},
  {floor: 21, busy: 2, type:1, title:"Book Stacks: PZ, Z; Juvenile Collection"},
  {floor: 22, busy: 2, type:2, title:"W. E. B. Du Bois Center"},
  {floor: 23, busy: 2, type:1, title:"Books Stacks: Q, R, S, T (except TR), U, V"},
  {floor: 24, busy: 2, type:2, title:"Archives Storage"},
  {floor: 25, busy: 2, type:2, title:"Special Collections"},
  {floor: 26, busy: 2, type:2, title:"Faculty Commons"}
]
